...
const SectionOneDateEnd = () => (
  <div className={`col-12 col-md-6 ${st.banner_field__col} ${st.banner_end}`}>
    <div className={st.field_name}>
      <span className={st.field_name__txt}>End Date</span>
    </div>
    <div className={`${st.date_field} ${st.end_date}`}>
...
export default SectionOneDateEnd;
